          ...
          {isLoading ? (
            ...
            <div className="fixed inset-0 bg-white dark:bg-gray-900 flex items-center justify-center z-50">
              <div className="relative">
                ...
                <div className="absolute animate-pulse w-16 h-16 rounded-full bg-blue-500/20 delay-100"></div>
                <div className="relative flex items-center justify-center w-16 h-16 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full text-white font-bold text-xl">
                  L
                </div>
              </div>
